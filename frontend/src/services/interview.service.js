...
export class InterviewApi {
    static generateReport = async (payload) => await apiClient("interview/generateReport", "POST", payload);
    ...
    static getResumePdf = async (payload) => await apiClient("interview/getResumePdf", "POST", payload);
}